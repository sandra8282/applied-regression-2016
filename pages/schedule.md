...
---- | ----- | --- | ------- | ------------------ | -------
 ...
 3   | Feb | 2, 4   | Least squares, multiple linear regression | <!-- [Lec 4](../assets/lectures/lecture4-mlr-intro/lecture4-mlr-intro.pdf), [Lab 2](../assets/labs/lab2-intro-mlr.pdf)--> | _ISL_ Ch 3.2-3.3; _PR_ Ch 2.
