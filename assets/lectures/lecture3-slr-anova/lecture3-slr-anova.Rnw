...
<<linmod1a, size='footnotesize', fig.height=3.5>>=
library(ggplot2)
theme_set(theme_bw())
...
\begin{frame}[fragile]{R example: centered $x$s}
...
<<linmodCentered1, size='scriptsize', fig.height=3.5>>=
